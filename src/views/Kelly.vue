  ...
  methods: {
    ...
    simulate() {
      for (let x = 1; x <= this.betno; x++) {
        var bid = this.incomes[x-1] * ((this.coeff*this.probability-1)/(this.coeff-1));
